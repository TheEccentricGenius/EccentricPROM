...
* Modules are available for ATMEL 28C series EEPROMs.
...
*
* The default hardware uses two 74LS595 shift registers as the low and
* high address registers.
**/
// NOTE: Hardware has changed....The hardware & software is currently stable.
//       28Cxx only supported currently....27Cxx compiles but remains untested.
...
#ifdef ENABLE_DEBUG_COMMANDS
        Serial.println();
        Serial.println(F("Debug commands are:"));
...
#endif /* ENABLE_DEBUG_COMMANDS */
        Serial.println();
        Serial.println(F("Where: s stands for start, e for end, d for data."));
        Serial.println(F("  e.g. d0 ff or D10000 1000F"));
        Serial.println();
        Serial.println(F("NOTE: ALL parameters MUST be in hex format."));
        break;
    }
