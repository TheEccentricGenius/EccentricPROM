...
// Pins D5..D12 are used for the data bus.
#define WE              13
bool OE = false;

// Set the status of the device control pins
static void enableChip()       { }
static void disableChip()      { delay(10); }
static void enableOutput()     { OE = true; }
static void disableOutput()    { OE = false;}
...
{
    PromAddressDriver::setAddress(address, OE);
}
...
bool PromDevice27::burnByte(byte value, uint32_t address)
{
    ...
    default: return false;  // PGM_A0 not implemented yet
    }
}
...
/* WARNING: CE control is not supported....use at your own risk....Without verify */
// Burn a byte to the chip and verify that it was written.
//
